                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        <div class="w-100">
                                            ...
                                            <div class="d-flex card-subtitle mb-3">
                                                ...
                                                <c:if test="${desBookList.readcount > 0 && desBookList.readcount < 1000}">
	                                    		...
	                                    		<c:if test="${desBookList.readcount > 999 && desBookList.readcount < 2000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    		...
	                                    		<c:if test="${desBookList.readcount > 1999 && desBookList.readcount < 3000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    		
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    		...
	                                    		<c:if test="${desBookList.readcount > 2999 && desBookList.readcount < 4000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    		...
	                                    		<c:if test="${desBookList.readcount > 3999}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
                                ...
                                <div class="card h-100 border-0 shadow">
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <span class="badge badge-pill p-2 badge-primary-light" style="margin-bottom:10px;">숙소</span>
                                            ...
                                            <div class="d-flex card-subtitle mb-3">
                                                <p class="flex-grow-1 mb-0 text-muted text-sm"></p>
                                                <c:if test="${roomBookList.readcount > 0 && roomBookList.readcount < 10}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    		...
	                                    		<c:if test="${roomBookList.readcount > 10 && roomBookList.readcount < 100}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    		...
	                                    		<c:if test="${roomBookList.readcount > 100 && roomBookList.readcount < 1000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    		
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    		...
	                                    		<c:if test="${roomBookList.readcount > 1000 && roomBookList.readcount < 10000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    		...
	                                    		<c:if test="${roomBookList.readcount > 10000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
                                ...
                                <div class="card h-100 border-0 shadow">
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <span class="badge badge-pill p-2 badge-secondary-light" style="margin-bottom:10px;">맛집</span>
                                            ...
                                            <div class="d-flex card-subtitle mb-3">
                                                <p class="flex-grow-1 mb-0 text-muted text-sm"></p>
                                                <c:if test="${resBookList.readcount > 0 && resBookList.readcount < 1000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    		...
	                                    		<c:if test="${resBookList.readcount > 999 && resBookList.readcount < 2000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    		...
	                                    		<c:if test="${resBookList.readcount > 1999 && resBookList.readcount < 3000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    		
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    		...
	                                    		<c:if test="${resBookList.readcount > 2999 && resBookList.readcount < 4000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    		...
	                                    		<c:if test="${resBookList.readcount > 3999}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
                                ...
                                <div class="card h-100 border-0 shadow">
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <span class="badge badge-pill p-2 badge-primary-light" style="margin-bottom:10px;">축제</span>
                                            ...
                                            <div class="d-flex card-subtitle mb-3">
                                                <p class="flex-grow-1 mb-0 text-muted text-sm"></p>
                                                <c:if test="${fesBookList.readcount > 0 && fesBookList.readcount < 10}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    		...
	                                    		<c:if test="${fesBookList.readcount > 10 && fesBookList.readcount < 100}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    		...
	                                    		<c:if test="${fesBookList.readcount > 100 && fesBookList.readcount < 1000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    		
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    		...
	                                    		<c:if test="${fesBookList.readcount > 1000 && fesBookList.readcount < 10000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    		...
	                                    		<c:if test="${fesBookList.readcount > 10000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
                            ...
                            <div class="col-sm-6 col-lg-4 mb-30px hover-animate" data-marker-id="59c0c8e322f3375db4d89128">
                                <div class="card h-100 border-0 shadow">
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <span class="badge badge-pill p-2 badge-secondary-light" style="margin-bottom:10px;">착한가게</span>
                                            ...
                                            <div class="d-flex card-subtitle mb-3">
                                                <p class="flex-grow-1 mb-0 text-muted text-sm"></p>
                                                <c:choose>
										<c:when test="${kindBookList.cnt >= 0}">
											<i class="fa fa-star text-warning"></i>
										</c:when>
									</c:choose>
									<c:choose>
										<c:when test="${kindBookList.cnt > 10}">
											<i class="fa fa-star text-warning"></i>
										</c:when>
										<c:otherwise>
											<i class="fa fa-star text-gray-300 "></i>
									...
									<c:choose>
										<c:when test="${kindBookList.cnt > 20}">
											<i class="fa fa-star text-warning"></i>
										</c:when>
										<c:otherwise>
											<i class="fa fa-star text-gray-300 "></i>
									...
									<c:choose>
										<c:when test="${kindBookList.cnt > 30}">
											<i class="fa fa-star text-warning"></i>
										</c:when>
										<c:otherwise>
											<i class="fa fa-star text-gray-300 "></i>
									...
									<c:choose>
										<c:when test="${kindBookList.cnt > 40}">
											<i class="fa fa-star text-warning"></i>
										</c:when>
										<c:otherwise>
											<i class="fa fa-star text-gray-300 "></i>
