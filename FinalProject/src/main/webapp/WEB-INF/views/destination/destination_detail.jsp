                ...
                <div class="col-lg-8">
                    ...
                    <div class="text-block" style="font-family: 'GmarketSansMedium'!important;">
                        ...
                        <div class="media d-block d-sm-flex review">
                            <div class="text-md-center mr-4 mr-xl-5"><img class="d-block avatar avatar-xl p-2 mb-2" src="${path}/resources/img/Busan/미모티콘3.jpeg" alt="Padmé Amidala"><span class="text-uppercase text-muted text-sm">Dec 2018</span></div>
                        ...
                        <div class="media d-block d-sm-flex review">
                            <div class="text-md-center mr-4 mr-xl-5"><img class="d-block avatar avatar-xl p-2 mb-2" src="${path}/resources/img/Busan/미모티콘1.png" alt="Princess Leia"><span class="text-uppercase text-muted text-sm">Dec 2018</span></div>
                            <div class="media-body">
